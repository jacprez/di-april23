...
-- NOTES FOR DAILY CHALLENGE
-- I had issues with pgadmin and setting up postgres (lise knows) so my table might be different from everyone elses because I couldn't follow in the class...

-- 1 - 3 actors in the table
-- 2 - there will be an error because we need to specify that the "blank" fields are NULL